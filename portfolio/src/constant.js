...
export const graphic = [
  { id: "1", name: "Inspiration", type: "", year: "", photo: `${Lucha1Insp1}`},
  { id: "2", name: "Inspiration", type: "", year: "", photo: `${Lucha1Insp2}`},
  { id: "3", name: "Lucha Libre Paris", type: "Campagne Alinea", year: "2014", photo: `${Lucha1}`},
  ...
  { id: "9", name: "Lucha Libre Paris", type: "Menu Recto", year: "2014", photo: `${LuchaMenu1}`},
  { id: "10", name: "Lucha Libre Paris", type: "Menu Verso", year: "2014", photo: `${LuchaMenu2}`},
  { id: "11", name: "Inspiration", type: "", year: "", photo: `${Lucha1Insp8}`},
  { id: "12", name: "Inspiration", type: "", year: "", photo: `${Lucha1Insp9}`},
  { id: "13", name: "Inspiration", type: "", year: "", photo: `${BootlagersV1Insp1}`},
  { id: "14", name: "Inspiration", type: "", year: "", photo: `${BootlagersV1Insp2}`},
  { id: "15", name: "Inspiration", type: "", year: "", photo: `${BootlagersV1Insp3}`},
  { id: "16", name: "Inspiration", type: "", year: "", photo: `${BootlagersV1Insp4}`},
  { id: "17", name: "Inspiration", type: "", year: "", photo: `${BootlagersV1Insp5}`},
  { id: "18", name: "Bootlagers Paris", type: "Campagne Alinea V1", year: "2014", photo: `${BootlagersV1}`},
  { id: "19", name: "Inspiration", type: "", year: "", photo: `${BootlagersV1Insp6}`},
  { id: "20", name: "Inspiration", type: "", year: "", photo: `${BootlagersV1Insp7}`},
  { id: "21", name: "Inspiration", type: "", year: "", photo: `${BootlagersV2Insp1}`},
  { id: "22", name: "Inspiration", type: "", year: "", photo: `${BootlagersV2Insp2}`},
  { id: "23", name: "Bootlagers Paris", type: "Campagne Alinea", year: "2014", photo: `${BootlagersV2}`},
  { id: "24", name: "Inspiration", type: "", year: "", photo: `${BootlagersV2Insp3}`},
  { id: "25", name: "Inspiration", type: "", year: "", photo: `${BootlagersV2Insp4}`},
  { id: "26", name: "Inspiration", type: "", year: "", photo: `${BootlagersV2Insp5}`},
  { id: "27", name: "Inspiration", type: "", year: "", photo: `${BootlagersV2Insp6}`},
  { id: "28", name: "Inspiration", type: "", year: "", photo: `${LipsInsp1}`},
  { id: "29", name: "Inspiration", type: "", year: "", photo: `${LipsInsp2}` },
  { id: "30", name: "Inspiration", type: "", year: "", photo: `${LipsInsp3}` },
  { id: "31", name: "Test 3D", type: "Projet Personel", year: "2014", photo: `${Lips}`},
  ...
  { id: "39", name: "Bootlagers Paris", type: "Campagne Alinea V3", year: "2014", photo: `${BootlagersV3}`},
  { id: "40", name: "Inspiration", type: "", year: "", photo: `${BootlagersV3Insp1}`},
  { id: "41", name: "Inspiration", type: "", year: "", photo: `${BootlagersV3Insp2}`},
  { id: "42", name: "Inspiration", type: "", year: "", photo: `${BootlagersV3Insp3}`},
  ...
  { id: "47", name: "Magazine MockUp 1", type: "Projet Personnel", year: "2018", photo: `${Mag1}`},
  { id: "48", name: "Magazine Mock Up 2", type: "Projet Personnel", year: "2018", photo: `${Mag2}`},
